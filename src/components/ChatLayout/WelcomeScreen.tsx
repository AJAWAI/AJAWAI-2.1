      ...
      <div className={styles.features}>
        <div className={styles.feature}>
          ...
          <div>
            ...
            <p>Best model for your device, automatically</p>
          </div>
        </div>
        <div className={styles.feature}>
        ...
        <div className={styles.feature}>
          ...
          <div>
            ...
            <p>Smart retrieval for continuity</p>
          </div>
        </div>
      </div>
